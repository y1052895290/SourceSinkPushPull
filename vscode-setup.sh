...
git clone --quiet --depth 1 --branch "$FACTORIO_VERSION" "https://github.com/wube/factorio-data.git" ".vscode/factorio-data"
rm -Rf ".vscode/factorio-data/.git"

rm -R ".vscode/flib"
git clone --quiet --depth 1 --branch "$FLIB_VERSION" "https://github.com/factoriolib/flib.git" ".vscode/flib"
